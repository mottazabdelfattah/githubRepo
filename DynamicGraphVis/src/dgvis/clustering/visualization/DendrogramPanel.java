...
package dgvis.clustering.visualization;
...
import dgvis.clustering.DefaultClusteringAlgorithm;
...
public class DendrogramPanel extends JPanel {
    ...
    public ClusterComponent createComponent(Cluster model) {
    ...
    public static String printTree(Cluster cluster, String out, int sp){
